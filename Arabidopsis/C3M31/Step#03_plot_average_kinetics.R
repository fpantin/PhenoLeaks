...
# # Plot the averages into a single PDF file (for visualization)
# pdf(file.path(dir_Exp, "Figures", paste(idExp, "Step#03d_plot_average_per_condition_use_VPD.pdf", sep = "_")), width = 8, height = 5)
# plot_avg_kin(Tr.avg.kPa, c("Col-0 - WW"), text.legend = c("Col-0"), idExperiment = idExp, xlim = XLIM, ylim = YLIM, use_VPD = T, x.legend = 1, y.legend = 2.3)
# dev.off()
