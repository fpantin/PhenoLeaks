...
df <- read.csv(file.path(dir_Exp, "Processed_data", "C3M31_pot_transpiration.csv"))
...
df$rule_out <- df$sum_out >= Inf #35 (here no strong outlier to be removed)
...
df$idWatering <- "WW" # just for easier use of the next script
