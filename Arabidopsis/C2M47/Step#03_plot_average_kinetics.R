...
pdf(file.path(getwd(), "Figures", paste(idExp, "Step#03a_plot_missing_data_correction.pdf", sep = "_")), width = 8, height = 5)
...
# Save the results
write.csv(Tr.avg, file.path(getwd(), "Corrected_data", "E_corr_offset_avg.csv"), row.names = F)
...
# Show the correction in a PDF file
pdf(file.path(getwd(), "Figures", paste(idExp, "Step#03b_plot_missing_data_correction_use_VPD.pdf", sep = "_")), width = 8, height = 5)
par(mfrow = c(2, 1), oma = c(0, 0, 2, 10))
for (trt in sort(unique(df$Trt)))
  {
...
# Save the results
write.csv(Tr.avg.kPa, file.path(getwd(), "Corrected_data", "E_corr_per_kPa_offset_avg.csv"), row.names = F)
...
# pdf(file.path(getwd(), "Figures", paste(idExp, "Step#03c_plot_average_per_condition.pdf", sep = "_")), width = 8, height = 5)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_pgm.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_sex1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_isa1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_ss4.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_mex1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_dpe1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_dpe2.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_pgi.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_amy3 bam1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_bam1 bam3.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_amy3.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_bam1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_bam3.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_abcb14-1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_abcb14-2.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin zoom_pgm_sex1.pptx", sep = "_")), paper = "A4", orient = "portrait", width = 3, height = 2.7)
dev.off()
...
pdf(file.path(getwd(), "Figures", paste(idExp, "Step#03d_plot_average_per_condition_use_VPD.pdf", sep = "_")), width = 8, height = 5)
...
pdf(file.path(getwd(), "Figures", paste(idExp, "Step#03e_plot_average_per_condition_use_SWC.pdf", sep = "_")), width = 8, height = 5)
do.call(plot_avg_kin, append(common.args, list(treatments = c("Col-0 - WW", "Col-0 - WS"),
                                               title_by_SWC = "Col-0",
...
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_WS_Col.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
dev.new(width = wd, height = ht, unit = "in", noRStudioGD = T)
plot_avg_kin(Tr.avg, c("pgm-1 - WW", "pgm-1 - WS"), text.legend = c(expression(paste(italic("pgm"), " - stable well-watered regime (n = 8)", sep = "")),
             ...
             scale_bar_pos_by_SWC = c(-0.6, 0.3), cex.legend = 0.6, x.legend = 2.75, y.legend = 2.2, irrig_show_mode = "mean")
graph2ppt(file = file.path(getwd(), "Figures", "PPTX", paste(idExp, "kin_WS_pgm.pptx", sep = "_")), paper = "A4", orient = "portrait", width = wd, height = ht)
dev.off()
...
pdf(file.path(getwd(), "Figures", paste(idExp, "Step#03f_plot_average_per_condition_use_SWC_use_VPD.pdf", sep = "_")), width = 8, height = 5)
do.call(plot_avg_kin, append(common.args, list(treatments = c("Col-0 - WW", "Col-0 - WS"),
                                               title_by_SWC = "Col-0",
                                               text.legend = c("well-watered (n = 8)", "stable water stress (n = 8)"))))
do.call(plot_avg_kin, append(common.args, list(treatments = c("pgm-1 - WW", "pgm-1 - WS"),
